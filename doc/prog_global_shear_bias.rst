...
.. code:: bash
    ...
    E-Run SHE_Validation 8.3 SHE_Validation_ValidateGlobalShearBias --workdir $WORKDIR  --matched_catalog_listfile $MC_LISTFILE --she_validation_test_results_product she_validation_test_results_product.xml
