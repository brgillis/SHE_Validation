...
.. code:: bash
    ...
    E-Run SHE_Validation 8.3 SHE_Validation_MatchToTU --workdir <dir> --she_validated_measurements_product <filename> --tu_output_product <filename> --matched_catalog <filename> [--log-file <filename>] [--log-level <value>] [--pipeline_config <filename>] [--match_threshold <value>]
...
.. code:: bash
    ...
    E-Run SHE_Validation 8.3 SHE_Validation_MatchToTU --she_validated_measurements_product $SVM_PRODUCT --tu_output_product $TU_PRODUCT --matched_catalog matched_catalog.xml
