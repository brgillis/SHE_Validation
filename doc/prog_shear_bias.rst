...
.. code:: bash
    ...
    E-Run SHE_Validation 9.0 SHE_Validation_ValidateShearBias --workdir $WORKDIR  --matched_catalog $MC_PRODUCT --she_validation_test_results_product she_validation_test_results_product.xml
