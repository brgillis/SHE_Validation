...
.. code:: bash
    ...
    E-Run SHE_Validation 8.2 SHE_Validation_ValidateShearBias --workdir <dir> [--log-file <filename>] [--log-level <value>] [--pipeline_config <filename>]
...
.. code:: bash
    ...
    E-Run SHE_Validation 8.2 SHE_Validation_ValidateShearBias --workdir $WORKDIR
