...
D_GAL_INFO_CONFIG_DEFAULTS = {**D_VALIDATION_CONFIG_DEFAULTS}
D_GAL_INFO_CONFIG_TYPES = {**D_VALIDATION_CONFIG_TYPES}
D_GAL_INFO_CONFIG_CLINE_ARGS = {**D_VALIDATION_CONFIG_CLINE_ARGS}
