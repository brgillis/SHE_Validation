...
D_DATA_PROC_CONFIG_DEFAULTS = {**D_VALIDATION_CONFIG_DEFAULTS}
D_DATA_PROC_CONFIG_TYPES = {**D_VALIDATION_CONFIG_TYPES}
D_DATA_PROC_CONFIG_CLINE_ARGS = {**D_VALIDATION_CONFIG_CLINE_ARGS}
