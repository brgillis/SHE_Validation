...
def mainMethod(args):
    ...
    logger = log.getLogger('SHE_Validation_ValidatePSFResInterp')

    logger.info('#')
    logger.info('# Entering SHE_Validation_ValidatePSFResInterp mainMethod()')
    logger.info('#')
    ...
    logger.info('#')
    logger.info('# Exiting SHE_Validation_ValidatePSFResInterp mainMethod()')
    logger.info('#')
