"""
:file: python/SHE_Validation_PSF/SHE_Validation_ValidatePSFModelErr.py
...
def mainMethod(args):
    ...
    logger = log.getLogger('SHE_Validation_ValidatePSFModelErr')

    logger.info('#')
    logger.info('# Entering SHE_Validation_ValidatePSFModelErr mainMethod()')
    logger.info('#')
    ...
    logger.info('#')
    logger.info('# Exiting SHE_Validation_ValidatePSFModelErr mainMethod()')
    logger.info('#')
