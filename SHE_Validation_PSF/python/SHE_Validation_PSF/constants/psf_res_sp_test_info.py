...
D_L_PSF_RES_SP_REQUIREMENT_INFO = {}
for test_case_info in L_PSF_RES_SP_TEST_CASE_INFO:
    D_L_PSF_RES_SP_REQUIREMENT_INFO[test_case_info.name] = PSF_RES_SP_REQUIREMENT_INFO
