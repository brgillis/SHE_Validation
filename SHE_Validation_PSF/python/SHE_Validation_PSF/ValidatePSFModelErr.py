"""
:file: python/SHE_Validation_PSF/python/SHE_Validation_PSF/ValidatePSFModelErr.py

:date: 10/06/22
:author: Bryan Gillis

Entry-point module for the PSFModelErr validation test
"""
...
def mainMethod(args):
    ...
    executor = SheValExecutor(run_from_args_function=run_validate_psf_model_err_from_args,
